...
| 1109 | 航班预订统计 | 中等 | 差分数组 | [笔记](./Notes/1109_corporate_flight_bookings.md) | [源码](./Code/1109.航班预订统计.py) |
...
- 差分数组：[1109. 航班预订统计](./Notes/1109_corporate_flight_bookings.md)

---

## 下一题推荐

> [56. 合并区间](./Notes/56_merge_intervals.md)
> 理由：区间类问题的另一种经典操作——合并重叠区间。做完差分数组的区间修改，接着练区间合并，强化「区间思维」。